...
| Psi-formula origin perturbation comparison | `python paper/plot_origin_perturbation_celltype_comparison.py --N-space 32 32 --heatmap-N-space 16 16 --N-ori 8 --space-extent 400 --fit-index 0 --experiment-name origin_horizontal_perturbation --seed 0 --max-neurons 60000 --skip-psi` |
