...
| Psi-formula origin perturbation comparison, polar distance/psi profiles | `python paper/plot_origin_perturbation_polar_celltype_comparison.py --N-space 50 50 --N-ori 8 --space-extent 200 --fit-index 0 --experiment-name origin_horizontal_perturbation_polar_psi --dh-values -20000 -10000 0 10000 20000 --seed 0 --max-neurons 50000 --response-mode matrix_approx --approx-order 8 --profiles-only` |
