...
| Direct-space psi origin perturbation | `python paper/plot_origin_perturbation_comparison.py --N-space 16 16 --N-ori 8 --fit-index 0 --experiment-name origin_horizontal_perturbation --seed 0 --max-neurons 50000` |
