...
| Psi-formula origin perturbation comparison | `python paper/plot_origin_perturbation_celltype_comparison.py --N-space 100 100 --heatmap-extent 50 50 --N-ori 8 --space-extent 400 --fit-index 0 --experiment-name origin_horizontal_perturbation --dh-values -10000 -5000 0 5000 10000 --seed 0 --max-neurons 200000 --skip-psi` |
| Psi-formula origin perturbation comparison, polar psi profiles | `python paper/plot_origin_perturbation_polar_celltype_comparison.py --N-space 100 100 --N-ori 8 --space-extent 400 --fit-index 0 --experiment-name origin_horizontal_perturbation_polar_psi --seed 0 --max-neurons 200000 --only-psi` |
