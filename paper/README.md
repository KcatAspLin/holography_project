...
| Psi-formula origin perturbation comparison, polar grid | `python paper/plot_origin_perturbation_polar_celltype_comparison.py --N-space 16 16 --N-ori 8 --fit-index 0 --experiment-name origin_horizontal_perturbation_polar --seed 0 --max-neurons 50000` |
